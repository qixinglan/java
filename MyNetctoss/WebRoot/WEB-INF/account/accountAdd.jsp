...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function checkreal_name(name){
            $("#realname_msg").css("color","black");
            var reg= /^[\u4E00-\u9FA5A-Za-z0-9]{2,20}$/;
            if(!reg.test(name.value)){
            $("#realname_msg").css("color","red");
            }
            }
            function checkIdcard_no(idcard){
            $("#idcardmsg").css("color","black");
             var reg= /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/;
            if(!reg.test(idcard.value)){
            $("#idcardmsg").css("color","red");
            }
            }
             function checkLoginName(login_name){
            $("#loginNameMsg").css("color","black");
             var reg= /^\w{2,30}$/;
            if(!reg.test(login_name.value)){
        ...
        <div id="main">       
            ...
            <form action="toAddAccount.do" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" name="real_name" onblur="checkreal_name(this);"/>
                    <span class="required">*</span>
                    <div class="validate_msg_long" id="realname_msg">20长度以内的汉字、字母和数字的组合</div>
                </div>
                <div class="text_info clearfix"><span>身份证：</span></div>
                <div class="input_info">
                    <input type="text" name="idcard_no" onblur="checkIdcard_no(this)"/>
                    <span class="required">*</span>
                    <div class="validate_msg_long" id="idcardmsg">正确的身份证号码格式</div>
                </div>
                <div class="text_info clearfix"><span>登录账号：</span></div>
                <div class="input_info">
                    <input type="text" name="login_name" onblur="checkLoginName(this)" />
                    <span class="required">*</span>
                ...
                <div id="optionalInfo" class="hide">
                    ...
                    <div class="input_info">
                        <input type="text" name="recommender_idcardno"/>
                    ...
                    <div class="input_info fee_type">
                        <input type="radio" name="gender" checked="checked" id="female" value="0" />
