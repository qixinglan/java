var CMapIcon = OpenLayers.Class({
    ...
    initialize: function(url, size, offset, calculateOffset) {
        ...
        this.imageDiv = createAlphaImageDiv(id);
     ...
     */
    draw: function(px) {
        modifyAlphaImageDiv(this.imageDiv, 
                                            null, 
                                            null, 
                                            this.size, 
                                            this.url, 
    ...
    moveTo: function (px) {
        ...
        if (this.imageDiv != null) {
            if (this.px == null) {
                ...
                modifyAlphaImageDiv(this.imageDiv, null, {
...
function createAlphaImageDiv (id, px, sz, imgURL, position, border, sizing, opacity, delayDisplay) {
 var div = OpenLayers.Util.createDiv();
 modifyAlphaImageDiv(div, id, px, sz, imgURL, position, border, sizing, opacity);
 return div;
};
 function modifyAlphaImageDiv(div, id, px, sz, imgURL, position, border, sizing, opacity) {
