...
<div style="background: url(${ctx}/images/table_bottom_bg.gif) left top repeat-x; height: 38px; width: 100%; text-align: center; font-size: 13px; line-height: 30px; color: #666666;">
	<table width="100%" height="36px" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td width="7%" align="left" style="padding-top:7px; vertical-align: top;">
