		...
		<script type="text/javascript">
			$(function() {
				...
				$("#mainGrid").jqGrid({
					...
					url		    : '${ctx}/data/sbgl/ydzf/search.action',
					colNames	: [
			...
			function changeSimNum(){
				...
				oselect=$("#pn"+id+"").html();
				$.findSim.load("findSim.action?useUnit="+useUnit);
...
<div class="main">
  ...
  <div class="buttonArea operation">
      <input type="button" id="btnAdd" id="btnAdd" class="bttn bicon-add"  value="新增" onclick="javascript:openAdd();"/>
