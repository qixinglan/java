...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function() {
		$.menu.init("#menuDetail",{first:"dzjg",second:"sbgl",third : "ydzfzd",});
		$("#buyUnit").text($.organization.formatter()($("#buyUnit").text() ));
		$("#status").text($.dictionary.formatter('ZFSBZT')($("#status").text() ));
	...
	<table class="comm-table" style="width:100%">
		<tbody>
			...
			<tr>
				...
				<th>使用单位：</th>
				<td ><span class='useUnit'><s:property value="entity.useUnit"/></span>,<span class='useSfsUnit'><s:property value="entity.useSfsUnit"/></span></td>
			</tr>
			<tr>
				<th>购买日期：</th>
        ...
        <div class="list-tbzoom">
			<div class="timeline" style="margin-left: 100px">
				...
				<c:forEach items="${deviceRecords}" varStatus="i" var="obj">
				   ...
				   <li style="width:200px " name="tName" class="dital d<c:out value="${i.count +1}" />">
