...
.docker{ height:30px;position:absolute;top:70px;left:60px;z-index:999;width:300px;padding-bottom:0px;margin-bottom:0px;}
.dwjk-box5 li {border:1px solid silver; font-size: 12px;}
.dwjk-box5 li.image{ width:200px; height:102px; vertical-align: middle; text-align: left;}
...
<body>
	...
	<div style="text-align: center;background-color: #F4F3EF">
		<table align="center" id="searchDiv" style="border:1px solid; width: 1300px;">
			<tbody>
				<tr>
					<td nowrap="nowrap">按天查询<input type="radio" name="time" checked="checked"
					...
					<th style="text-align: right;vertical-align:middle;width:80px;">查询时间：</th>
					<td class="cc" width="360px" align="left">
					...
					<td style="display:none"><input type="text" name="min"
						style="width:16px;height:10px" disabled="disabled" />时 至 <input
						type="text" name="max" style="width:16px;height:10px"
						disabled="disabled" />时
					</td>
					<td class="cc" style="text-align:right; padding-left:5px; margin-bottom:2px;">
						...
						-->
						<input type="button" onclick="gjd()" class="bttn bicon-reset" id="resetBtn" value="轨迹点" />
						<input type="button" onclick="gjx()" class="bttn bicon-reset" id="resetBtn" value="轨迹线" />
						<input type="button" onclick="gjhf()" class="bttn bicon-reset" id="resetBtn" value="轨迹回放" />
						<input type="button" onclick="hdrd()" class="bttn bicon-reset" id="resetBtn" value="活动热点" />
						<input type="button" onclick="back()" class="bttn bicon-reset" id="resetBtn" value="返回" />
					</td>
				</tr>
			</tbody>
		</table>
	</div>
	<div id="map" style="width: 99%; height: 90%;border: 1px solid #ccc;"></div>
	<div id="kdContainer">
		<div id="kd">
...
function back(){
	window.location = "${ctx}/data/dzjg/dwjk/dwjk-person.jsp?orgId=<%=request.getParameter("orgId")%>";
}
</script>