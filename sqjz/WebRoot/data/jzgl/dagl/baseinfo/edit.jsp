<%@ page language="java" import="java.util.*,com.nci.dcs.common.utils.LoginInfoUtils" pageEncoding="UTF-8"%>
...
<body>
	...
	<div class="main">
		<div class="breadcrumb-nav"> <span>您当前的位置：矫正管理 -> 社区服刑人员档案管理 -> 司法局服刑人员基本信息编辑</span> </div>
	...
	<script type="text/javascript">
		$(function() {
			...
			if(refreshValue=='1'){
				$.fxrybaseinfo.init('edit', '<%=fxryId%>', {container:'.container-middle'});
			}
		});
		function refresh(){
