...
<div class="man_zone2">
  <table width="99%" align="center"  cellpadding="0" cellspacing="0" class="jieguo_bt">
   ...
   <form id="addform" action="${ctx}/sys/action/add.action" method="post" onsubmit="return validateForm()">
  ...
  <table width="99%" border="0" align="center"  cellpadding="0" cellspacing="1" class="table_xz">
    <tr>
      ...
      <td width="85%" colspan="3" style="background-color:#F9FCFB;"><input name="name" id="name" type="text" class="shuru required" msg="模块名称" chklen="32"/><span class="red">*</span></td>
    </tr>
    <tr>
      <td width="15%" class="table_xz_title" style="background:#F3F8F7;">模块描述</td>
      <td width="85%" colspan="3" style="background-color:#F9FCFB;"><input name="info" type="text" class="shuru" msg="模块描述" chklen="160"/></td>
    </tr>  
  </table>  
