...
K.options = {
	...
	zIndex : 811213,
	items : [
		'|', 'undo', 'redo', '|', 'preview', 'print', 'cut', 'copy', 'paste', '|', 'justifyleft', 'justifycenter', 'justifyright',
		'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent',  'selectall', 'image', 'table', 'hr', 'pagebreak','link', 'unlink', '|',  '/',
		'formatblock','|', 'fontname', '|','fontsize', '|', 'forecolor', '|','hilitecolor', '|','bold','|',
		'italic','|', 'underline','|', 'strikethrough','|', 'lineheight',  '|', 'insertfile'
	],
