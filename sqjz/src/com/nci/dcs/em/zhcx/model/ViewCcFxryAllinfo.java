...
/**
 * ViewCcFxryAllinfo entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "VIEW_CC_FXRY_ALLINFO_SEARCH", schema = "SQJZ")
public class ViewCcFxryAllinfo implements java.io.Serializable {
	...
	/** default constructor */
	public ViewCcFxryAllinfo() {
	}


	/** full constructor */
	public ViewCcFxryAllinfo(String id, String code, String state,
			...
			Date wearTime,Date releaseTime,Date alarmTime,String alarmType,String opinion) {
		this.id = id;
		this.code = code;
		this.state = state;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewCcFxryAllinfo))
			return false;
		ViewCcFxryAllinfo castOther = (ViewCcFxryAllinfo) other;
