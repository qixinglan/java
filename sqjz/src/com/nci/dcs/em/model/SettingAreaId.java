 ...
 */
@Embeddable
public class SettingAreaId implements java.io.Serializable {
	...
	/** default constructor */
	public SettingAreaId() {
	}

	/** full constructor */
	public SettingAreaId(String areaId, String settingId) {
		this.areaId = areaId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SettingAreaId))
			return false;
		SettingAreaId castOther = (SettingAreaId) other;
