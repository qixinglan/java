...
public class SuperviseDevicePairAction extends BaseAction<ViewDevicePair> {
	...
	public String searchHistory() {
		String pairNumber = request.getParameter("pairNumber");
		getRequestPage();
		page.getCriterions().add(Restrictions.eq("pairDeviceNumber", pairNumber));
		
		superviseDeviceService.searchHistory(page);
