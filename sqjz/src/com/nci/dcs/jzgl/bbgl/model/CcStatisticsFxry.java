 ...
 */
@Entity
@Table(name = "CC_STATISTICS_FXRY", schema = "SQJZ")
public class CcStatisticsFxry implements java.io.Serializable {
	...
	/** default constructor */
	public CcStatisticsFxry() {
	}

	/** minimal constructor */
	public CcStatisticsFxry(String id) {
		this.id = id;
	}

	/** full constructor */
	public CcStatisticsFxry(String id, String orgid, Integer year, Integer month,
