...
import com.nci.dcs.jzgl.dagl.service.FxryPunishService;

@SuppressWarnings("serial")
public class FxryPunishAction extends BaseAction<FxryPunish> {
	@Autowired
	private FxryPunishService fxryPunishService;
	...
	public String list() throws Throwable {
		...
		Page<FxryPunish> page = getRequestPage();
		page.getCriterions().add(Restrictions.eq("fxryid", fxryId));
		fxryPunishService.findPaged(page);
		return SUCCESS;
	}
	...
	public String delete() throws Throwable {
		...
		try {
			...
			if (idsParam != null && !idsParam.isEmpty()) {
				...
				for (String id : ids) {
					lastId = id;
					fxryPunishService.delete(id.trim());
					++deleted;
				}
	...
	public String add() throws Throwable {
		try {
			...
			fxryPunishService.update(entity);
