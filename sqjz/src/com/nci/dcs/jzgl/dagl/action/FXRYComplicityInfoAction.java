...
public class FXRYComplicityInfoAction extends BaseAction<FXRYComplicityInfo>{
	
	@Autowired
	FXRYComplicityInfoService service;
	...
	public String list() throws Throwable {
		...
		List<FXRYComplicityInfo> list = service.getByFXRYId(fxryId);//从数据库加载
