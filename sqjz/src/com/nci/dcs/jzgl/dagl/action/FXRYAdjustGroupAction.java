...
public class FXRYAdjustGroupAction extends BaseAction<FXRYAdjustGroup>{
	
	@Autowired
	FXRYAdjustGroupService service;
	...
	public String list() throws Throwable {
		...
		List<FXRYAdjustGroup> list = service.getByFXRYId(fxryId);//从数据库加载
