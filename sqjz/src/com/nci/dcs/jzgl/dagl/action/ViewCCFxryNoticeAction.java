...
import com.nci.dcs.jzgl.dagl.service.ViewCCFxryNoticeService;
import com.nci.dcs.official.service.OrganizationInfoService;

public class ViewCCFxryNoticeAction  extends BaseAction<ViewCCFxryNotice>{
	...
	@Autowired
	private ViewCCFxryNoticeService service;
	...
	public String getData() {
		...
		//特管权限
		System.out.println(getUser().getIsws());
		...
		List<ViewCCFxryNotice> resultList = page.getResult();
		System.out.println(resultList.size());
		long adjustPeriod = 0, remainDays = 0;
		Date now = new Date();
		for (ViewCCFxryNotice temp : resultList) {
	...
	public String view() throws Throwable {
		...
		ViewCCFxryNotice info = service.get(id);
