...
public class FXRYMoreCrimeAction extends BaseAction<FXRYMoreCrime>{
	
	@Autowired
	FXRYMoreCrimeService service;
	...
	public String list() throws Throwable {
		...
		List<FXRYMoreCrime> list = service.getByFXRYId(fxryId);//从数据库加载
