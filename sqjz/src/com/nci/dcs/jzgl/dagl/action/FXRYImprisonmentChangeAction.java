...
public class FXRYImprisonmentChangeAction extends BaseAction<FXRYImprisonmentChange>{
	
	@Autowired
	FXRYImprisonmentChangeService service;
	...
	public String list() throws Throwable {
		...
		List<FXRYImprisonmentChange> list = service.getByFXRYId(fxryId);//从数据库加载
