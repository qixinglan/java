...
import com.nci.dcs.jzgl.dagl.service.FxryIllegalService;

@SuppressWarnings("serial")
public class FxryIllegalAction extends BaseAction<FxryIllegal> {
	@Autowired
	private FxryIllegalService fxryIllegalService;
	...
	public String list() throws Throwable {
		...
		Page<FxryIllegal> page = getRequestPage();
		page.getCriterions().add(Restrictions.eq("fxryid", fxryId));
		fxryIllegalService.findPaged(page);
		return SUCCESS;
	}
	...
	public String delete() throws Throwable {
		...
		try {
			...
			if (idsParam != null && !idsParam.isEmpty()) {
				...
				for (String id : ids) {
					lastId = id;
					fxryIllegalService.delete(id.trim());
					++deleted;
				}
	...
	public String add() throws Throwable {
		try {
			...
			fxryIllegalService.update(entity);
