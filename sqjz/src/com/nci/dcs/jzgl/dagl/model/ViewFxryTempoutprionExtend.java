...
/**
 * ViewFxryTempoutprionExtend entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "VIEW_FXRY_TEMPOUTPRION_EXTEND", schema = "SQJZ")
public class ViewFxryTempoutprionExtend implements java.io.Serializable {
	...
	/** default constructor */
	public ViewFxryTempoutprionExtend() {
	}

	/** full constructor */
	public ViewFxryTempoutprionExtend(String id, String name, String code,
