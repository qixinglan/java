 ...
 */
@Entity
@Table(name = "VIEW_FXRY_READY_RELEASE", schema = "SQJZ")
public class ViewFxryReadyRelease implements java.io.Serializable {
	...
	/** default constructor */
	public ViewFxryReadyRelease() {
	}

	/** full constructor */
	public ViewFxryReadyRelease(String id, String name, String code,
