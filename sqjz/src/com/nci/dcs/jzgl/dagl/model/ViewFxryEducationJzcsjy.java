 ...
 */
@Entity
@Table(name = "VIEW_FXRY_EDUCATION_JZCSJY", schema = "SQJZ")
public class ViewFxryEducationJzcsjy implements java.io.Serializable {
	...
	/** default constructor */
	public ViewFxryEducationJzcsjy() {
	}

	/** full constructor */
	public ViewFxryEducationJzcsjy(String id, String name, String code,
