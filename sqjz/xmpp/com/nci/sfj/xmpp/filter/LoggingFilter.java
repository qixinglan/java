 ...
 *
 */
package com.nci.sfj.xmpp.filter;
...
public class LoggingFilter extends IoFilterAdapter {
	...
	private LogLevel exceptionCaughtLevel = LogLevel.INFO;
	...
	public void exceptionCaught(NextFilter nextFilter, IoSession session,
		...
		log(exceptionCaughtLevel, "程序发生异常 :", cause);
	...
	public void messageReceived(NextFilter nextFilter, IoSession session,
		...
		log(messageReceivedLevel, session.getRemoteAddress() + "的消息到达: {}",
				message);
	...
	public void messageSent(NextFilter nextFilter, IoSession session,
		...
		log(messageSentLevel, "发送消息至" + session.getRemoteAddress() + ": {}",
	...
	public void sessionCreated(NextFilter nextFilter, IoSession session)
			throws Exception {
		log(sessionCreatedLevel, "会话成功创建");
