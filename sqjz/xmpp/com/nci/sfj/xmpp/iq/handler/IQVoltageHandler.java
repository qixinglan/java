...
/**
 * Description:处理主机低电报警阈值设置的回执信息
 * 
 * @author Shuzz
 * @since 2014年7月3日下午3:36:45
 */
public class IQVoltageHandler extends IQHandler {

	private static final String NAMESPACE = "dzjg:iq:voltageVal";

	/**
	 * Constructor.
	 */
	public IQVoltageHandler() {
	}
