...
/**
 * Description:处理静默时间设置的回执信息
 * 
 * @author Shuzz
 * @since 2014年7月3日下午3:36:45
 */
public class IQSilentHandler extends IQHandler {

	private static final String NAMESPACE = "dzjg:iq:silentList";

	/**
	 * Constructor.
	 */
	public IQSilentHandler() {
	}
