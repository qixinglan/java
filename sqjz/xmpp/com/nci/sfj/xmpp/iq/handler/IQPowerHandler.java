 ...
 */
public class IQPowerHandler extends IQHandler {

	private static final String NAMESPACE = "dzjg:iq:power";

	/**
	 * Constructor.
	 */
	public IQPowerHandler() {
	}
