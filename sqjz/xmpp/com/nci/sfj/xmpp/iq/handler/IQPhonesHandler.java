...
/**
 * Description:处理设置电话的回执信息
 * 
 * @author Shuzz
 * @since 2014年7月3日下午3:36:45
 */
public class IQPhonesHandler extends IQHandler {

	private static final String NAMESPACE = "dzjg:iq:telPhones";

	/**
	 * Constructor.
	 */
	public IQPhonesHandler() {
	}
