...
@Service
public class SupervisionReportIllServiceZFDC extends IReportServiceNew {
	@Autowired
	...
	private String getReportUrl() {
		...
		criterions.add(Restrictions.eq("reportType", "ILL"));
	...
	public ReportData getReportData(Bmb org) {
		...
		List list = viewReportFxryInfoService.findByCriteria(criterions,
				SupervisionIllExamination.class, projectionList, orders);
