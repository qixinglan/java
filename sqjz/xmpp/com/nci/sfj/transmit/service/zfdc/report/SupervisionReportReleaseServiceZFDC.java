...
@Service
public class SupervisionReportReleaseServiceZFDC extends IReportServiceNew {
	@Autowired
	...
	private String getReportUrl() {
		...
		criterions.add(Restrictions.eq("reportType", "JJ"));
	...
	public ReportData getReportData(Bmb org) {
		...
		List list = viewReportFxryInfoService.findByCriteria(criterions,
				SupervisionRelease.class, projectionList, orders);
