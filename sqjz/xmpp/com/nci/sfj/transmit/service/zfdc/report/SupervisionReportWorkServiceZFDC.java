...
@Service
public class SupervisionReportWorkServiceZFDC extends IReportServiceNew {
	@Autowired
	...
	private String getReportUrl() {
		...
		criterions.add(Restrictions.eq("reportType", "PW"));
	...
	public ReportData getReportData(Bmb org) {
		...
		List list = viewReportFxryInfoService.findByCriteria(criterions,
				SupervisionPublicWork.class, projectionList, orders);
