...
@Service
public class SupervisionReportMonthServiceZFDC extends IReportServiceNew {
	@Autowired
	...
	private String getReportUrl() {
		...
		criterions.add(Restrictions.eq("reportType", "MR"));
	...
	public ReportData getReportData(Bmb org) {
		List<Criterion> criterions = new ArrayList<Criterion>();
		criterions.add(Restrictions.lt("createTime",
		...
		List list = viewReportFxryInfoService.findByCriteria(criterions,
				SupervisionMonthReport.class, projectionList, orders);
