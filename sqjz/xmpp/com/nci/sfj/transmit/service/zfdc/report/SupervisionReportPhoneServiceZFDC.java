...
@Service
public class SupervisionReportPhoneServiceZFDC extends IReportServiceNew {
	@Autowired
	...
	private String getReportUrl() {
		...
		criterions.add(Restrictions.eq("reportType", "PR"));
	...
	public ReportData getReportData(Bmb org) {
		...
		List list = viewReportFxryInfoService.findByCriteria(criterions,
				SupervisionPhoneReport.class, projectionList, orders);
