...
@Service
public class SupervisionReportEducationServiceZFDC extends IReportServiceNew {
	@Autowired
	...
	private String getReportUrl() {
		...
		criterions.add(Restrictions.eq("reportType", "FE"));
	...
	public ReportData getReportData(Bmb org) {
		...
		List list = viewReportFxryInfoService.findByCriteria(criterions,
				SupervisionFirstEducation.class, projectionList, orders);
