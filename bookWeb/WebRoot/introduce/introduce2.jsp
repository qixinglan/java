...
if(a.value!=""){
window.location.href="introduce2.do?type="+b.innerText+"&currpage="+a.value;
}
}
</script>
       ...
       <div class="top_logo left"> <a href="http://127.0.0.1:8081/bookWeb/main.do" class="left" title="七星书城"><img width=200 height=50 alt="七星书城" src="http://127.0.0.1:8081/bookWeb/images/logo1.jpg" /></a>
        ...
        <a href="http://127.0.0.1:8081/bookWeb/lookcart.do">购物车</a>|
          <a href="http://127.0.0.1:8081/bookWeb/user/fixuser.jsp"><%=user.getUname()%> </a>|
           <a href="logout.do?p=introduce2&currpage=<%=currpage%>&type=<%=type%>">注销</a>
         <%} %> 
        </div>
    </div>
</div>
...
<table align="center">
<tr>
<td>当前类型:<span id="type"><%=type%></span>&nbsp;&nbsp;&nbsp;</td><td>当前第<%=currpage%>页</td>
<td><a href="introduce2.do?type=<%=type %>&currpage=<%=currpage-1%>">上一页</a></td><td><a href="introduce2.do?type=<%=type%>&currpage=<%=currpage+1%>">下一页</a></td>
