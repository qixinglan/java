...
<BODY>
	<div id="body">
		<div id="title">
			...
			<div id="logo"><a href="http://127.0.0.1:8081/bookWeb/main.do"><img src="../images/logo1.jpg" width=200 height=60 /></a></div>
			<br>
			
			<div style="font-size:2em;color:black;font-weight:bold">欢迎注册七星电子书</div>
		</div>
				...
				<form method="post" action="../regist.do" onSubmit="return check();">			
					<table>						
						...
						<tr>
							...
							<td id="user_prompt">用户名由英文字母和数字组成的4-16位字符，以字母开头</td>
						</tr>
						<tr>
						...
						<tr>
							<td ><a>验证码</a></td>
							<td  ><input id="codema"  name="codema" type="text" onblur="idhidden()"/><br><span id="errorcodema" style="color:red">验证码错误</span></td>
