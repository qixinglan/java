...
function checkUser(){
	...
	function dden(){
	document.getElementById("errorcodema").style.display="none";
	}				
...
<BODY>
	...
	<div id="body">
		<h1 style="font-size:1.8em">用户信息更改</h1>
				...
				<form method="post" action="http://127.0.0.1:8081/bookWeb/fixuser.do" onSubmit="return check();">			
					<table>						
						...
						<tr>
							<td ><a>验证码</a></td>
							<td  ><input id="codema"  name="codema" type="text" onblur="dden()"/><br><span id="errorcodema" style="color:red">验证码错误</span></td>
