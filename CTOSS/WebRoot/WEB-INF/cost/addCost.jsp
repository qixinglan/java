    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function checkName() {
            	...
            	// 校验资费名称是格式
            	var exp=/^[\u4E00-\u9FA5A-Za-z0-9_]{1,50}$/;
            	if(!exp.test(costName)) {
            		nameFlag =false;
            		$("#costNameMsg").text("资费名称格式不对！");
            		$("#costNameMsg").addClass("error_msg");
            		return;
            	}
            	// 校验资费名称是否重复
            	$.post(
            		"checkCostName",
            		{"name":costName},
            		function(data){ //data是接收返回值的，实际上就是Action中输出属性repeat
            			var repeat = data;
            			if(repeat) {
            				nameFlag = false;
        ...
        <div id="main">            
            ...
            <form action="" method="" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" id="costName" class="width300"  name="name" onblur="checkName();"/>
