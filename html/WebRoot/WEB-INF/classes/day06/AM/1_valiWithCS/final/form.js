...
//Step1.2:将提示框的className属性设置为""，表示清除样式。
...
function inputFocus(txtObj,divID){
	...
	if(msg.id=="pwd_msg")
		...
		msg.innerHTML = "10个字符以内的字母、数字和下划线的组合";
}	
...
function validateDatas(){
	...
	var rUserName = validateUserName(txtObj, "userName_msg");
	txtObj=document.getElementById("pwd");
	var rPwd = validatePwd(txtObj, "pwd_msg");
	return rUserName && rPwd;
}