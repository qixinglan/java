...
<html>
 ...
 <form action="${action}" method="post">
 <h2>登录</h2>
 <h3><span>${error5}</span></h3>
 <p>用户：<input type="text" name="name" value="${name}"/><span>${error3}</span></p>
 <p>密码：<input type="password" name="pwd" /><span>${error4}</span></p>
 <h4><input type="submit" value="登录"></h4>
 </form>
 </div>
 <div>
 ...
 <form action="${action}" method="post">
 <h2>登录</h2>
 <h3><span>${error8}</span></h3>
 <p>用户：<input type="text" name="name" value="${name}"/><span>${error6}</span></p>
 <p>密码：<input type="password" name="pwd" /><span>${error7}</span></p>
 <h4><input type="submit" value="登录"></h4>
 </form>
 </div>
 <div>
 ...
 <form action="${action}" method="post">
 <h2>登录</h2>
 <h3><span>${error9}</span></h3>
 <p>用户：<input type="text" name="name" value="${name}"/></p>
