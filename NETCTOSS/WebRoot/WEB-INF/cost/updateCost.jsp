...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="fixCost.do" method="post" class="main_form">
                ...
                <div class="text_info clearfix"><span>资费类型：${cost.costType}</span></div>
                <div class="input_info fee_type">
                
                    <input type="radio" name="costType" id="monthly"  <c:if test="${cost.costType==49}">checked</c:if>  value="1" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" id="package" <c:if test="${cost.costType==50}">checked</c:if> value="2" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="costType" id="timeBased" <c:if test='${cost.costType==51}'>checked</c:if> value="3" onclick="feeTypeChange(3);" />
