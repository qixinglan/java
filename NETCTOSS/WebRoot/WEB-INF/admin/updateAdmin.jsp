...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="fixAdmin.do" method="post" class="main_form">
                    ...
                    <div class="input_info_high">
                        <div class="input_info_scroll">
                            <ul>
                                ...
                                <li><input type="checkbox" value="${r.role_id }" name="roleIds"
                                <c:forEach items="${admin.roles}" var="ar">
                                <c:if test="${r.role_id==ar.role_id}">checked</c:if></c:forEach> />${r.name}</li>
                                </c:forEach>
                            </ul>
                        </div>
                        <span class="required">*</span>
