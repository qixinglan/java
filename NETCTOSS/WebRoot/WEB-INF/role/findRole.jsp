    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            function deleteRole(id) {
                ...
                if(r){
                location.href="deleteRole.do?role_id="+id;
                }
            }
        </script>
    </head>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    <input type="button" value="增加" class="btn_add" onclick="location.href='addRole.do';" />
                </div>  
                <!--删除的操作提示-->
                ...
                <div id="data">                      
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="button" value="修改" class="btn_modify" onclick="location.href='updateRole.do?role_id=${r.role_id}'"/>
                ...
                <a href="findRole.do?currentPage=${rolePage.currentPage-1}">上一页</a>
               	...
               	<c:forEach begin="1" var="i" end="${rolePage.totalPages }">
               	<c:choose>
               	<c:when test="${i==rolePage.currentPage}">
               	<a href="findRole.do?currentPage=${i}" class="current_page">${i}</a></c:when>
               	<c:otherwise>
               	<a href="findRole.do?currentPage=${i}" >${i}</a></c:otherwise>
               	</c:choose>
               	</c:forEach>		
                 <c:choose>
